...
class BaseOptions():
    def __init__(self):
        ...
        self.exp_name = 'POLED' # 'POLED'  or 'TOLED' or 'SYNTH'

    def initialize(self):
        if self.exp_name == 'POLED': ## low-light  colorshift noise
            # Data and pre-trained weights for POLED dataset
            self.parser.add_argument('--dataroot', type=str, default='D:/DLproj/UDC/Data/POLED/train', help='path to images')
            self.parser.add_argument('--testroot', type=str, default='D:/DLproj/UDC/Data/POLED/test', help='path to images')
            ...
            self.parser.add_argument('--dataroot', type=str, default='D:/DLproj/UDC/Data/TOLED/train', help='path to images')
            self.parser.add_argument('--testroot', type=str, default='D:/DLproj/UDC/Data/TOLED/test', help='path to images')
