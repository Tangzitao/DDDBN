...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--display_freq', type=int, default=4800, help='frequency of showing training results on screen')
		self.parser.add_argument('--print_freq', type=int, default=240, help='frequency of showing training results on console and save log')
		...
		self.parser.add_argument('--which_epoch', type=str, default='1', help='which epoch to load? set to latest to use latest cached model') ############ latest 20

		self.parser.add_argument('--phase', type=str, default='train', help='train, val, test, etc')
		self.parser.add_argument('--niter', type=int, default=2000, help='total # of iter')
